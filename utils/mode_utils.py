...
cmd_max_walk = np.array([1.0, 0.8, 0.6, 1.3])  # 行走模式
cmd_max_run = np.array([3.0, 0.8, 1.0, 1.3])  # 奔跑模式
cmd_max_disturbance = np.array([1.0, 0.8, 0.6, 1.3])  # 抗扰动模式（允许控制速度，使用行走模式的速度限制）
